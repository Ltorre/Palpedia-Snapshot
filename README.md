...
- **Breed new** removes only the owned copies from the starting collection, forcing the route to add that Pal’s own parent branch. Use this when the Pals you own have poor traits but you want to breed a better version before continuing.
